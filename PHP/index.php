<?php
$job = [
    'job_name' => ['GB', 'Космонавт', 'Моряк'],
    'job_data' => ['2022', '2000', '1999'],
    'job_data_end'=> ['2023', '2007', '2003'],
    'job_desc' => ['Много интересной работы', 'Всегда было интересно, Мокро'],
];
?>
<!DOCTYPE html>
<html>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>?php echo $job[$i]["job_data"]; ?> - ?php echo $job[$i]["job_data_end"]; ?>
          <p>?php echo $job[$i]["job_desc"]; ?></p>
          <hr>
        </div>
        <?php endfor; ?>
